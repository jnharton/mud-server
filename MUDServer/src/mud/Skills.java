...
public final class Skills {
	...
	public static final Skill KNOWLEDGE_ARCANA = new Skill("Knowledge (arcana)", 17, "INT", new Classes[] { Classes.BARD, Classes.CLERIC, Classes.MONK, Classes.SORCERER, Classes.WIZARD });
	public static final Skill KNOWLEDGE_DUNGEONEERING = new Skill("Knowledge (dungeoneering)", 18, "INT", new Classes[] { Classes.BARD, Classes.RANGER, Classes.WIZARD });
	public static final Skill KNOWLEDGE_GEOGRAPHY = new Skill("Knowledge (geography)", 19, "INT", new Classes[] { Classes.BARD, Classes.RANGER, Classes.WIZARD });
	public static final Skill KNOWLEDGE_HISTORY = new Skill("Knowledge (history)", 20, "INT", new Classes[] { Classes.BARD, Classes.CLERIC, Classes.WIZARD });
	public static final Skill KNOWLEDGE_LOCAL = new Skill("Knowledge (local)", 21, "INT", new Classes[] { Classes.BARD, Classes.ROGUE, Classes.WIZARD });
	public static final Skill KNOWLEDGE_NATURE = new Skill("Knowledge (nature)", 22, "INT", new Classes[] { Classes.BARD, Classes.DRUID, Classes.RANGER, Classes.WIZARD });
	public static final Skill KNOWLEDGE_NOBILITY = new Skill("Knowledge (nobility)", 23, "INT", new Classes[] { Classes.BARD, Classes.PALADIN, Classes.WIZARD });
	public static final Skill KNOWLEDGE_PLANAR = new Skill("Knowledge (planar)", 24, "INT", new Classes[] { Classes.BARD, Classes.CLERIC, Classes.WIZARD });
	public static final Skill KNOWLEDGE_RELIGION = new Skill("Knowledge (religion)", 25, "INT", new Classes[] { Classes.BARD, Classes.CLERIC, Classes.MONK, Classes.PALADIN, Classes.WIZARD });
