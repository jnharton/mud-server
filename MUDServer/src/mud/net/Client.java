 ...
 * 
 * also, added boolean variable 'tn'
 * also, added writeln to make a second string version of the write method which
 * tacks on a newline
 */
...
public class Client implements Runnable {
	 ...
	 */
	public Client(MUDServer parent, String host, int port) {
		this.parent = parent;
		this.host = host;
		this.port = port;
	 ...
	 * @throws IOException
	 */
	public Client(MUDServer parent, Socket socket) throws IOException {
		this.socket = socket;
